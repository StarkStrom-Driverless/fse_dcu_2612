 ...
 *
 *              Four values, each as a bar with its numeric readout: brake
 *              pressure front and rear, air pressure front and rear.
 *
 *              ### Screen layout (480 × 320)
 *
 *              ```
 *              ┌──────────────────────────────────────┐
 *              │ DBG PRESSURE                  ▪▪▪▪▪▪ │ ← shared header
 *              ├──────────────────────────────────────┤
 ...
 *              The four pressures are float subjects, which LVGL's own
 *              lv_obj_bind_state_if_lt/gt() refuses — see ui_quantity.h. Air
 *              pressure has limits on both sides: too little is as bad as too
 *              much.
 *
...
/**
 * @brief Create the air and brake pressure debug screen.
 *
