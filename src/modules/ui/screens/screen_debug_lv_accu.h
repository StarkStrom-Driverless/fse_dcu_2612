 ...
 * @brief       Debug screen for lov voltage accumulator
 *
 * @details     
 *
 ...
 * @code
 *   // on screen enter:
 *   lv_indev_set_group(right_encoder_indev, screen_debug_lv_accu_get_group());
 *   // on screen leave:
 *   lv_indev_set_group(right_encoder_indev, NULL);
 * @endcode
 *
 * @return  Pointer to the lv_group_t.  Valid after screen_debug_lv_accu_create().
 */
