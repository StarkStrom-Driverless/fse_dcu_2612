...
#ifndef MODULES_UI_SCREENS_SCREEN_DEBUG_TRACTIVE_SYSTEM_H
#define MODULES_UI_SCREENS_SCREEN_DEBUG_TRACTIVE_SYSTEM_H
 ...
 */
lv_obj_t *screen_debug_tractive_system_create(void);
