 ...
 *
 * Brake pressure front and rear, then air pressure front and rear, in a single
 * full-width column.
 *
...
static void build_bars(lv_obj_t *scr)
{
    ...
    build_bar_row(col, &ui_sig_brake_pressure_front, ui_sig_brake_pressure_front.label);
    build_bar_row(col, &ui_sig_brake_pressure_rear, ui_sig_brake_pressure_rear.label);
    build_bar_row(col, &ui_sig_air_pressure_front, ui_sig_air_pressure_front.label);
    build_bar_row(col, &ui_sig_air_pressure_rear, ui_sig_air_pressure_rear.label);
}
